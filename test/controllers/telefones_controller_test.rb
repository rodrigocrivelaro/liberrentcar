...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { ddd: @telefone.ddd, numero: @telefone.numero, pessoa_id: @telefone.pessoa_id, preferencial: @telefone.preferencial, tipoTelefone_id: @telefone.tipoTelefone_id } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { ddd: @telefone.ddd, numero: @telefone.numero, pessoa_id: @telefone.pessoa_id, preferencial: @telefone.preferencial, tipoTelefone_id: @telefone.tipoTelefone_id } }
