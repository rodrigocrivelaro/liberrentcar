...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { documento: @pessoa.documento, dt_nascimento: @pessoa.dt_nascimento, email: @pessoa.email, nome: @pessoa.nome } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { documento: @pessoa.documento, dt_nascimento: @pessoa.dt_nascimento, email: @pessoa.email, nome: @pessoa.nome } }
